...
function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <motion.article
      ...
      className="group glass flex flex-col overflow-hidden rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:border-accent/40 hover:shadow-xl hover:shadow-black/15"
    >
      {/* Gradient banner */}
      <div className="relative flex h-20 items-center justify-center overflow-hidden bg-gradient-to-br from-accent-solid/25 via-transparent to-accent-2/20">
        <Icon
          size={34}
          ...
          <div className="mt-auto pt-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 rounded-full border border-line px-3.5 py-1.5 text-xs font-medium text-muted transition-colors duration-200 hover:border-accent/50 hover:text-text"
              >
                <LinkIcon size={13} />
                {label}
              </a>
...
export function Projects() {
  ...
  return (
    <Section id="projects" className="bg-bg-soft/50">
      ...
      <motion.div layout className="grid items-start gap-6 md:grid-cols-2 lg:grid-cols-3">
